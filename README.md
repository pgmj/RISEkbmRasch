...
There is now a [vignette](https://pgmj.github.io/raschrvignette/) that is intended to be the next step after you skimmed this README. You can find a sample Rasch analysis there, complete with output from most of the package functions.
